...
export default function Hero() {
  return (
    <section className=''>
      <div className='mt-10 grid grid-cols-1 grid-rows-auto gap-2 lg:grid-cols-6 items-center xl:grid-cols-7'>
      ...
      <div className='w-auto h-[400px] overflow-hidden rounded-3xl mt-4 lg:h-[500px]'>
        <img
          src={heroImage}
        ...
        <div className='w-36 h-36 bg-mosswood-200 absolute rounded-full left-1/2 -translate-x-1/2 -translate-y-20 flex justify-center items-center'>
          <div className='w-28 h-28 bg-kelp-800 rounded-full flex justify-center items-center'>
            <button className='text-mosswood-200 font-source-sans-3 text-md uppercase text-center p-2'>
              Find more now
            </button>
          </div>
        </div>
